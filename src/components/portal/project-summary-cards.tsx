...
/**
 * Compact card replacing the old "Upcoming milestone" tile. Shows the
 * count of activities currently Not started / In progress / Done so
 * clients see at-a-glance where work sits without hunting through phases.
 */
